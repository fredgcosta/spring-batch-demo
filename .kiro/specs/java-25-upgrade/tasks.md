...
- [ ] 1. Configurar o Rewrite_Maven_Plugin e o repositório de artefatos no `pom.xml`
  - [ ] 1.1 Declarar o `rewrite-maven-plugin` com a Recipe_UpgradeToJava25 ativa
  ...
  - [ ] 1.2 Declarar o Code_Genome_Repository e a configuração de credenciais (Caminho A)
...
- [ ] 2. Executar o Dry_Run e decidir o caminho de aquisição
  - [ ] 2.1 Garantir árvore de trabalho limpa e executar o Dry_Run
  ...
  - [ ]* 2.2 Aplicar o fallback de aquisição do artefato se o Caminho A falhar
...
- [ ] 3. Checkpoint — Avaliar o Dry_Run antes de aplicar
...
- [ ] 4. Aplicar a recipe e realizar os ajustes manuais de build
  - [ ] 4.1 Aplicar a recipe com `rewrite:run`
  ...
  - [ ] 4.2 Definir explicitamente `java.version=25` no `pom.xml`
  ...
  - [ ] 4.3 Alinhar a versão do Lombok entre dependência e annotation processor
...
- [ ] 5. Verificar compatibilidade de dependências e plugins com Java 25
  - [ ] 5.1 Verificar e ajustar dependências/plugins incompatíveis
  ...
  - [ ] 5.2 Tratar APIs depreciadas/removidas remanescentes
...
- [ ] 6. Checkpoint — Build compila no Java 25
...
- [ ] 7. Atualizar imagens Docker e referências de JDK
  - [ ] 7.1 Atualizar a imagem base no `docker/Dockerfile`
  ...
  - [ ] 7.2 Atualizar tags e defaults de variáveis nos arquivos docker-compose
  ...
  - [ ] 7.3 Atualizar menções de JDK no `README.md`
...
- [ ] 8. Adicionar testes baseados em propriedades para o Job_Batch
  - [ ] 8.1 Adicionar a dependência jqwik e a infraestrutura de teste do job
  ...
  - [ ]* 8.2 Escrever o teste de propriedade para o grafo de entidades
  ...
  - [ ]* 8.3 Escrever o teste de propriedade de preservação de comportamento
  ...
  - [ ]* 8.4 Escrever teste de exemplo/edge case para falha do job
...
- [ ] 9. Checkpoint — Suíte de testes verde no Java 25
...
- [ ] 10. Validar a execução do Job_Batch no Java 25
  - [ ]* 10.1 Executar o `souJavaJob` sobre o arquivo de entrada padrão
